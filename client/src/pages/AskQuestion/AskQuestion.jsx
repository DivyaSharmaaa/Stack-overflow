    ...
    <div className="ask-question">
      <div className="ask-ques-container">
        ...
        <form onSubmit={handleSubmit}>
          <div className="ask-form-cotainer">
            ...
            <label htmlFor="ask-ques-body">
              ...
              <textarea name="" id="ask-ques-body" onChange={(e) => {setQuestionBody(e.target.value)}} cols="30" rows="10" onKeyUpCapture={handleEnter}></textarea>
