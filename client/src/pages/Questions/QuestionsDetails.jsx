...
const url = 'https://stack-overflow-clone-app-sjdp.onrender.com/'
                        ...
                        <section className="question-details-container">
                            ...
                            <div className="question-details-container-2">
                                <div className="question-votes">
                                    <img src={upvote} alt=""  width ='24' className="votes-icon" onClick={handleUpVote}/>
                                    <p>{question.upVote.length - question.downVote.length}</p>
                                    <img src={downvote} alt=""  width ='24' className="votes-icon" onClick={handleDownVote}/>
